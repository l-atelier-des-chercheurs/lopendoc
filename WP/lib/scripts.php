...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_css2', get_template_directory_uri() . $assets['css2'], false, null);
  ...
  wp_enqueue_script('roots_js2', get_template_directory_uri() . $assets['js2'], array(), null, true);
}
